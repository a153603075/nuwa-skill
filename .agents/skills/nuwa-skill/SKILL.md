...
如果用户要求写老鸣TV《反常识》系列，且主题涉及心理学效应、认知偏差、人性实验、真实案件或经典实验，应重点学习 `反常识8_巴纳姆效应_老鸣修改稿.md` 和 `反常识9_达克效应_老鸣修改稿.md` 的结构。
其中：
- `反常识8_巴纳姆效应_老鸣修改稿.md` 重点学习：实验现场开头、概念后置、机制拆解、核心比喻、标签风险和结尾升华。
- `反常识9_达克效应_老鸣修改稿.md` 重点学习：真实案件开头、荒诞行为引出反常识、避免浅层嘲讽、经典实验揉碎、生活案例因果链、反馈校准式结尾。
写同类文章时，不要一句话一段。每段应完成一个完整意思，每段可以包含2到5句话。

如果用户要求写老鸣TV《反常识》系列，且主题有经典心理学、行为经济学或社会学实验，应优先学习 `反常识8_巴纳姆效应_老鸣修改稿.md` 的结构：先用实验现场开头，再讲反常识结果，再引出理论，不要一开头直接说“今天聊一个极度反常识的现象”。这些文件是老鸣TV《反常识》系列的最高优先级风格样本。
